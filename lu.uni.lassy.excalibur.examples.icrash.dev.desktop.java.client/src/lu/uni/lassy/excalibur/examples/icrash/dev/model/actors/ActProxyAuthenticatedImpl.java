...
public abstract class ActProxyAuthenticatedImpl extends UnicastRemoteObject implements ActProxyAuthenticated {
	 ...
	 */
	public PtBoolean oeLogin(DtLogin aDtLogin,DtEncodedPassword aEncodePassword)  throws RemoteException, NotBoundException{
		return this._serverSideActor.oeLogin(aDtLogin, aEncodePassword);
	}
