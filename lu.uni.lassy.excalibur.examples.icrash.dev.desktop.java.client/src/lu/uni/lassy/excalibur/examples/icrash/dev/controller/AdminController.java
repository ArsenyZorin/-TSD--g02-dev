...
public class AdminController extends AbstractUserController {
	 ...
	 */
	public PtBoolean oeAddCoordinator(String coordinatorID, String login, String password) throws ServerOfflineException, ServerNotBoundException, IncorrectFormatException, NoSuchAlgorithmException, IOException, InvalidKeySpecException{
		if (getUserType() == UserType.Admin){
			...
			CtKeyPair aKeyPair = new CtKeyPair();
			aKeyPair.getKeys();
			DtPublicKey aDtPublicKey = aKeyPair.getPublicKey();
			aKeyPair.getPrivateKey().saveToFile(new PtString(login));
			...
			ht.put(aDtPublicKey, aDtPublicKey.getValue().toString());
			try {
				return actorAdmin.oeAddCoordinator(aDtCoordinatorID, aDtLogin, aDtPassword, aDtPublicKey);
